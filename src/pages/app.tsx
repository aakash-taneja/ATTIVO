...
export default function App() {
  ...
  return (
    <div style={{ fontFamily: "'Barlow Condensed', 'Orbitron', sans-serif" }}>
      ...
      {/* Main Content */}
      <main style={{ padding: '2rem 0', backgroundColor: '#111111', minHeight: 'calc(100vh - 120px)', color: 'white' }}>
      ...
      <footer style={{ 
        ...
        <div>
          ATTIVO SPORTS PLATFORM © {new Date().getFullYear()}
        </div>
        <div style={{ marginTop: '0.5rem', fontSize: '0.875rem', color: '#FF6A00' }}>
