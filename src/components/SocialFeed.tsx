  ...
  const handleConfirmData = async (extractedData: ExtractedActivityData) => {
    ...
    try {
      ...
      const newPost: Post = {
        ...
        content:
          newPostContent || `New ${extractedData.type} activity completed!`,
        ...
        <div className="card">
          ...
          <div style={{ marginBottom: "1rem" }}>
            <select
              ...
              onChange={(e) =>
                setSelectedSportType(e.target.value as SportType)
              }
              style={{
                width: "auto",
                ...
                <div className="post-activity-data">
                  <div>
                    <div className="post-activity-stat">
                      {post.activityData.type.charAt(0).toUpperCase() +
                        post.activityData.type.slice(1)}
                    </div>
                  ...
                  {post.activityData.duration && (
                    <div>
                      <div className="post-activity-stat">
                        {post.activityData.duration} min
                      </div>
                  ...
                  {post.activityData.distance && (
                    <div>
                      <div className="post-activity-stat">
                        {post.activityData.distance.toFixed(2)} km
                      </div>
              ...
              <div className="post-actions">
                ...
                <div className="post-action">
                  ...
                  >
                    ...
                    <path
                      fillRule="evenodd"
                      d="M10.5 1.5a.5.5 0 0 1 0 1h-6a.5.5 0 0 0-.5.5v6.793l.854-.854a.5.5 0 1 1 .707.708l-1.5 1.5a.5.5 0 0 1-.707 0l-1.5-1.5a.5.5 0 1 1 .707-.708L3 9.793V2.5a1.5 1.5 0 0 1 1.5-1.5h6z"
                    />
                  </svg>
                  <span>Share</span>
                </div>
